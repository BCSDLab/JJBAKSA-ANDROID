...
object FormDataUtil {
    ...
    fun getImageBody(key: String, file: File): MultipartBody.Part {
        return MultipartBody.Part.createFormData(
            name = key,
            filename = file.name,
            body = file.asRequestBody(URLConnection.guessContentTypeFromName(file.name).toMediaType())
        )
    }
    ...
    @SuppressLint("Range")
    fun Uri.asMultipart(key: String = "multipartFile", contentResolver: ContentResolver): MultipartBody.Part? {
